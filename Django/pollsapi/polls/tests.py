...
class TestPoll(APITestCase):
    def setUp(self):
        ...
        def setup_user():
            User = get_user_model()
            return User.objects.create_user('test',email='testuser@test.com',password='test@786')

        self.user = setup_user()

    # Test case Using factory
    def test_list(self):
    ...
    # Test case Using API Client
    def test_list2(self):
        self.client.login(username="test", password="test@786")
