...
class Restaurant(models.Model):
    ...
    user = models.ForeignKey(User, default=1,on_delete=models.CASCADE)#One to Many
...
class Dish(models.Model):
    ...
    user = models.ForeignKey(User, default=1,on_delete=models.CASCADE)#1-M
    date = models.DateField(default=date.today)
    image = models.ImageField(upload_to="myrestaurants", blank=True, null=True)
    restaurant = models.ForeignKey(Restaurant, null=True, related_name='dishes',on_delete=models.CASCADE)#one to many
